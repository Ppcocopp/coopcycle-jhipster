...
describe('Customer e2e test', () => {
  ...
  // const customerSample = {"adress":"clicks-and-mortar Fantastic Handcrafted","balance":66590};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/users',
      body: {"login":"scalable Bûcherie product","firstName":"Artémis","lastName":"Henry"},
    }).then(({ body }) => {
      user = body;
    });
  });
  ...
  describe('new Customer page', () => {
    ...
    it.skip('should create an instance of Customer', () => {
      cy.get(`[data-cy="adress"]`).type('virtual').should('have.value', 'virtual');

      cy.get(`[data-cy="balance"]`).type('24250').should('have.value', '24250');

      cy.get(`[data-cy="phone"]`).type('0428361119').should('have.value', '0428361119');
